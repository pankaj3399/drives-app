    ...
    endpoints: (builder) => ({
        getOrders: builder.query({
            query: ({ page, customerId }) => ({
                url: customerId ? `/admin/get-all-orders?page=${page || 1}&customerId=${customerId}` : `/admin/get-all-orders?page=${page || 1}`,
                method: 'GET',
            }),
        }),
        ...
        getCustomers: builder.query({
            query: ({ page, email }) => ({
                url: (email && email !== '') ? `/admin/get-all-customers?page=${page || 1}&email=${email}` : `/admin/get-all-customers?page=${page || 1}`,
                method: 'GET',
            }),
        }),
